...
allternit agent:run my-agent`} />
  ...
  // GIZZI CODE DOCUMENTATION
  'gizzi-code/quickstart': {
    title: 'Gizzi Code Quickstart',
    description: 'Get started with Gizzi Code in 5 minutes',
    breadcrumb: ['Gizzi Code', 'Quickstart'],
    badge: 'New',
    sections: [
      {
        id: 'what-is-gizzi',
        title: 'What is Gizzi Code?',
        content: (
          <>
            <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              Gizzi Code is the AI-powered terminal interface for the Allternit ecosystem. 
              It allows you to interact with AI agents using natural language commands from your terminal.
            </p>
            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                <h4 className="font-semibold text-[var(--text-primary)] mb-1">Multi-Provider</h4>
                <p className="text-sm text-[var(--text-secondary)]">Claude, GPT, Kimi, Gemini</p>
              </div>
              <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                <h4 className="font-semibold text-[var(--text-primary)] mb-1">Computer Use</h4>
                <p className="text-sm text-[var(--text-secondary)]">Browser & desktop automation</p>
              </div>
              <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                <h4 className="font-semibold text-[var(--text-primary)] mb-1">Sandboxed</h4>
                <p className="text-sm text-[var(--text-secondary)]">Secure execution modes</p>
              </div>
            </div>
          </>
        ),
      },
      {
        ...
        content: (
          <>
            <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              Install Gizzi Code using one of these methods:
            </p>
            <div className="space-y-3 mb-6">
              <div className="bg-[var(--bg-secondary)] rounded-lg p-4">
                <p className="text-xs text-[var(--text-muted)] mb-2">macOS/Linux (Recommended)</p>
                <code className="text-sm text-[var(--accent-orange)]">curl -fsSL https://install.gizziio.com/install | bash</code>
              </div>
              <div className="bg-[var(--bg-secondary)] rounded-lg p-4">
                <p className="text-xs text-[var(--text-muted)] mb-2">Windows (PowerShell)</p>
                <code className="text-sm text-[var(--accent-orange)]">irm https://install.gizziio.com/install.ps1 | iex</code>
              </div>
              <div className="bg-[var(--bg-secondary)] rounded-lg p-4">
                <p className="text-xs text-[var(--text-muted)] mb-2">npm (Universal)</p>
                <code className="text-sm text-[var(--accent-orange)]">npm install -g @gizzi/gizzi-code</code>
              </div>
            </div>
          </>
        ),
        ...
        content: (
          <>
            ...
            <div className="space-y-2 mb-6">
              <div className="bg-[var(--bg-secondary)] rounded-lg p-3 flex items-center gap-3">
                <code className="text-sm text-[var(--accent-orange)]">gizzi-code</code>
                <span className="text-sm text-[var(--text-muted)]">Start interactive TUI mode</span>
              </div>
              <div className="bg-[var(--bg-secondary)] rounded-lg p-3 flex items-center gap-3">
                <code className="text-sm text-[var(--accent-orange)]">gizzi-code run "List all files"</code>
                <span className="text-sm text-[var(--text-muted)]">Run a single command</span>
              </div>
              <div className="bg-[var(--bg-secondary)] rounded-lg p-3 flex items-center gap-3">
                <code className="text-sm text-[var(--accent-orange)]">gizzi-code --help</code>
                <span className="text-sm text-[var(--text-muted)]">View all commands</span>
              </div>
            </div>
          </>
        ),
  ...
  'gizzi-code/installation': {
    title: 'Installation',
    description: 'All methods to install Gizzi Code',
    breadcrumb: ['Gizzi Code', 'Installation'],
    sections: [
      {
        id: 'curl',
        title: 'curl (macOS/Linux)',
        content: (
          <>
            <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
            ...
            <p className="text-[var(--text-secondary)] text-sm">
              This installs the <code className="px-1.5 py-0.5 bg-[var(--code-bg)] rounded">gizzi-code</code> binary to <code className="px-1.5 py-0.5 bg-[var(--code-bg)] rounded">~/.local/bin/</code>.
            </p>
          </>
        ),
      },
      {
        ...
        content: (
          <>
            ...
            <p className="text-[var(--text-secondary)] text-sm">
              Installs to <code className="px-1.5 py-0.5 bg-[var(--code-bg)] rounded">%LOCALAPPDATA%\gizzi\</code> and adds to PATH.
            </p>
          </>
        ),
      },
      {
        ...
        content: (
          <>
            <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              If you have Node.js installed, use npm:
            </p>
            <div className="bg-[var(--bg-secondary)] rounded-lg p-4 mb-4">
              <code className="text-sm text-[var(--accent-orange)]">npm install -g @gizzi/gizzi-code</code>
            </div>
  ...
  'gizzi-code/cli': {
    ...
    breadcrumb: ['Gizzi Code', 'CLI Reference'],
    sections: [
      {
        id: 'core-commands',
        title: 'Core Commands',
        content: (
          <>
            <div className="space-y-3">
              <div className="flex items-start gap-4 p-4 bg-[var(--bg-secondary)] rounded-lg">
                <code className="text-sm text-[var(--accent-orange)] min-w-[200px]">gizzi-code</code>
                <span className="text-[var(--text-secondary)]">Start the TUI interface</span>
              </div>
              <div className="flex items-start gap-4 p-4 bg-[var(--bg-secondary)] rounded-lg">
                <code className="text-sm text-[var(--accent-orange)] min-w-[200px]">gizzi-code run "prompt"</code>
                <span className="text-[var(--text-secondary)]">Execute a single command</span>
              </div>
              <div className="flex items-start gap-4 p-4 bg-[var(--bg-secondary)] rounded-lg">
                <code className="text-sm text-[var(--accent-orange)] min-w-[200px]">gizzi-code provider set &lt;name&gt;</code>
                <span className="text-[var(--text-secondary)]">Set AI provider</span>
              </div>
              <div className="flex items-start gap-4 p-4 bg-[var(--bg-secondary)] rounded-lg">
                <code className="text-sm text-[var(--accent-orange)] min-w-[200px]">gizzi-code models list</code>
                <span className="text-[var(--text-secondary)]">List available models</span>
              </div>
              <div className="flex items-start gap-4 p-4 bg-[var(--bg-secondary)] rounded-lg">
                <code className="text-sm text-[var(--accent-orange)] min-w-[200px]">gizzi-code config get &lt;key&gt;</code>
                <span className="text-[var(--text-secondary)]">Get configuration value</span>
              </div>
            </div>
          </>
        ),
  ...
  'gizzi-code/configuration': {
    title: 'Configuration',
    description: 'Configure Gizzi Code settings',
    breadcrumb: ['Gizzi Code', 'Configuration'],
    sections: [
      {
        id: 'config-file',
        ...
        content: (
          <>
            ...
            <ul className="space-y-2 mb-6">
              <li className="text-[var(--text-secondary)]"><strong>macOS/Linux:</strong> <code className="px-1.5 py-0.5 bg-[var(--code-bg)] rounded">~/.config/gizzi/config.yaml</code></li>
              <li className="text-[var(--text-secondary)]"><strong>Windows:</strong> <code className="px-1.5 py-0.5 bg-[var(--code-bg)] rounded">%APPDATA%/gizzi/config.yaml</code></li>
            </ul>
            <CodeBlock
...
harness:
  ...
  'gizzi-code/providers': {
    title: 'AI Providers',
    description: 'Supported AI providers and configuration',
    breadcrumb: ['Gizzi Code', 'Providers'],
    sections: [
      {
        id: 'supported',
        ...
        content: (
          <>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                <h4 className="font-semibold text-[var(--text-primary)] mb-1">Anthropic Claude</h4>
                <p className="text-sm text-[var(--text-secondary)] mb-2">Best for reasoning and code</p>
                <code className="text-xs text-[var(--accent-orange)]">gizzi-code provider set anthropic</code>
              </div>
              <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                <h4 className="font-semibold text-[var(--text-primary)] mb-1">OpenAI GPT</h4>
                <p className="text-sm text-[var(--text-secondary)] mb-2">Fast and reliable</p>
                <code className="text-xs text-[var(--accent-orange)]">gizzi-code provider set openai</code>
              </div>
              <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                <h4 className="font-semibold text-[var(--text-primary)] mb-1">Moonshot Kimi</h4>
                <p className="text-sm text-[var(--text-secondary)] mb-2">Long context support</p>
                <code className="text-xs text-[var(--accent-orange)]">gizzi-code provider set kimi</code>
              </div>
              <div className="p-4 bg-[var(--bg-secondary)] rounded-lg">
                <h4 className="font-semibold text-[var(--text-primary)] mb-1">Google Gemini</h4>
                <p className="text-sm text-[var(--text-secondary)] mb-2">Multimodal capabilities</p>
                <code className="text-xs text-[var(--accent-orange)]">gizzi-code provider set gemini</code>
              </div>
            </div>
          </>
        ),
  ...
  'gizzi-code/computer-use': {
    title: 'Computer Use',
    description: 'Browser and desktop automation',
    breadcrumb: ['Gizzi Code', 'Computer Use'],
    sections: [
      {
        id: 'overview',
        title: 'Overview',
        content: (
          <>
            <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              Computer Use enables agents to control browsers and desktop applications. 
              Perfect for web research, form filling, and UI automation.
            </p>
            <h4 className="font-semibold text-[var(--text-primary)] mb-2">Capabilities</h4>
            <ul className="space-y-2 mb-6">
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-orange)]" />
                <span className="text-[var(--text-secondary)]">Navigate to URLs and take screenshots</span>
              </li>
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-orange)]" />
                <span className="text-[var(--text-secondary)]">Click elements and type text</span>
              </li>
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-orange)]" />
                <span className="text-[var(--text-secondary)]">Execute JavaScript in browser</span>
              </li>
              <li className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[var(--accent-orange)]" />
                <span className="text-[var(--text-secondary)]">Mouse and keyboard control</span>
              </li>
            </ul>
          </>
        ),
