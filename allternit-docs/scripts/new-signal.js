 ...
 * Usage: node scripts/new-signal.js YYYY-MM-DD slug-goes-here "Article Title"
 */
...
if (!date || !slug || !title) {
  console.log('Usage: node scripts/new-signal.js YYYY-MM-DD slug-goes-here "Article Title"');
  console.log('Example: node scripts/new-signal.js 2026-04-09 openai-gpt5 "OpenAI Announces GPT-5"');
  process.exit(1);
}
